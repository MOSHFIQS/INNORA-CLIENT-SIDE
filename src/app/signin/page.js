        ...
        <div>
            <div className="flex flex-col items-center justify-center h-screen ">
                <div className="w-full max-w-md rounded-lg shadow p-6 border border-gray-300 bg-[#c0a783]">
                    <h2 className="text-3xl font-bold mb-4 text-center uppercase text-white">SignIn to INNORA</h2>
                    <form onSubmit={handleSignIn} className="flex flex-col gap-2">
                        ...
                        <div className='w-full'>
                            ...
                            <p className="mt-4 text-center w-full hover:text-white">
                                Don't have an account? <Link href={'/signup'} className='text-blue-600 font-bold hover:text-white'>SignUp</Link>
                            </p>
                        </div>
