...
const RequestForm = () => {
    return (
        <div className="h-screen dark:bg-[#1c1c1c] bg-indigo-50 dark:text-white flex items-center justify-center px-4 pt-20">
                ...
                <div className="bg-[url('/your-marble-bg.jpg')] bg-cover bg-center px-6 py-12 rounded-lg">
                    <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <input
                            ...
                            className="p-3 border border-gray-300 focus:outline-none dark:hover:text-white dark:hover:border-white"
                        />
                        <input
                            type="text"
